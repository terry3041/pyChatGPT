...
api5 = ChatGPT(session_token, verbose=True)  # verbose mode (print debug messages)
...
api6 = ChatGPT(auth_type='openai', email='example@xxx.com', password='password', verbose=True)
